...
export default function RegionListings() {
  ...
  const buildParams = useCallback(
    (pageNum) => {
      const params = { page: pageNum, limit: PAGE_LIMIT, regionId };
  ...
  return (
    <div>
      ...
      <div className="px-6 pt-12 text-center">
        <Link
          to="/"
          className="mb-4 inline-block text-sm text-ink-700 hover:underline"
        >
      ...
      <div className="mx-auto max-w-6xl px-6 pb-16">
        ...
        {!loading && !error && listings.length === 0 && (
          <p className="text-center text-muted">
            Bu viloyatda hali e'lonlar yo'q. E'lon qoldirish uchun{" "}
            <Link to="/listings/new" className="text-ink-700 underline">
              bu yerga kiring
            </Link>
          </p>
        )}
